    ...
    <div className="w-full px-4 pt-16">
      <div className=" max-w-xl p-5 mx-auto bg-white border-50">
        ...
        <form>
          ...
          <div className="inputFollwer w-1/4 flex-shrink justify-center px-3">
            <button className="flex-shrink rounded-full shadow-input w-32 h-8 bg-primary-grad text-white font-thin forhover">
              Save change
            </button>
          </div>
        </form>
